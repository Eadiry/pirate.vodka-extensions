...
export const CONSOLIDATE_DISCOVER_SECTIONS_KEY = "readcomiconline-consolidate-discover-sections";
export const CONSOLIDATED_DISCOVER_GROUP_ORDER_KEY =
  "readcomiconline-consolidated-discover-group-order";
...
export const DOMAIN_MODE_KEY = "readcomiconline-domain-mode";
export const USE_BACKUP_DOMAIN_FALLBACK_KEY = "readcomiconline-use-backup-domain-fallback";
...
export const DOMAIN_MODE_OPTIONS = [
  { id: "main", title: "Main Domain" },
  { id: "backup", title: "Backup Domain" },
];
